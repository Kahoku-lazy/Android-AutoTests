...
| 语言 | 文件 | 内容 |
|------|------|------|
| Python | `references/python-code.md` | 命名 / 行数限制 / import / 类型注解 / api.py·views.py·models.py 规范 / 异常处理 / 响应格式 |
| 前端 | `references/frontend.md` | 命名 / 行数限制 / 架构红线 / 数据加载三态 / CSS 层级 / Element Plus |
