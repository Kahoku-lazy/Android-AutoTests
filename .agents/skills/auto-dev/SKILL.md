...
Step -1.1: 领域映射
  ...
  映射知识来源: android-autotests-rules/references/troubleshooting.md 速查表 / frontend.md / database.md

  ↓
Step -1.2: 快速探索（只读，定位根因）
  并行执行:
  - grep 关键词 android-autotests-rules/references/troubleshooting.md → 匹配已知问题模式
