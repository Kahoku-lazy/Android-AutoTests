# Pedagogy Reference — Socratic Mastery Learning for Reading
...
5. Walk through a minimal worked example together (still ask them to fill in steps)
...
6. **Wait** — let them wrestle with the contradiction. Do NOT explain immediately.
...
5. If a concept drops back, address it before advancing
