...
# 5. 检查模块结构完整性
for app in device_pool element_locator case_manager test_runner report_generator ai_assistant; do
...
# 6. 检查前端 api.js 完整性
for mod in dashboard device-pool element-locator case-manager test-runner report-generator ai-assistant; do
