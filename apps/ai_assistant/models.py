...
class AIConversation(models.Model):
    ...
    status = models.CharField(max_length=20, default='active')
    agent_scope_session_id = models.CharField(max_length=200, default='', blank=True, help_text='AgentScope session ID for SSE streaming')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class AIExecutionLog(models.Model):
    ...
    task = models.ForeignKey(AITask, on_delete=models.SET_NULL, null=True, blank=True, related_name='logs')
