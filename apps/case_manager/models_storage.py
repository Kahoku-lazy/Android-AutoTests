"""case-manager storage/business function test case model → cm_storage_testcases.

Table-based CRUD. Default columns: 编号, 标题, 优先级, 前置条件, 步骤, 预期结果.
...
class StorageTestCase(models.Model):
    """Storage / business function test case — table-style editing."""

    id = models.CharField(max_length=200, primary_key=True)
    title = models.CharField(max_length=500, verbose_name="用例标题")
    case_type = models.CharField(max_length=32, default="storage")
    ...
    steps = models.TextField(default="", blank=True, verbose_name="用例步骤")
    ...
    directory = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="storage_testcases",
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="unique_storage_directory_title",
            ),
        ]
