...
urlpatterns = [
    ...
    # Web group — list keep; writes → 410
    path("web-groups", list_web_groups, name="web_groups_list"),
    path("web-groups/create", group_write_gone, name="web_group_create"),
    path("web-groups/batch-move", group_write_gone, name="web_groups_batch_move"),
    ...
    # API group — list keep; writes → 410
    path("api-groups", list_api_groups, name="api_groups_list"),
    path("api-groups/create", group_write_gone, name="api_group_create"),
    path("api-groups/batch-move", group_write_gone, name="api_groups_batch_move"),
