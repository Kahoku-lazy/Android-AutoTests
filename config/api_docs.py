    ...
    # ── element-locator (11 endpoints) ──
    {
        ...
        "items": [
            ...
            },
            {
                ...
                "desc": "页面元素列表(支持过滤)",
                "body": None,
                "response": {"status": "bool", "elements": "list[dict]"},
                "errors": [],
    ...
    # ── device-pool (10 endpoints) ──
    {
        ...
        "items": [
            ...
            },
            {
                ...
                "response": {"status": "bool", "message": "str", "serial": "str"},
                "errors": [
            ...
            },
            {
                ...
                "response": {"status": "bool", "serial": "str", "connected": "bool"},
            ...
            },
            {
                ...
                "desc": "切换当前活动设备",
                "body": None,
                "response": {"status": "bool", "current": "str"},
                "errors": [],
            ...
            },
            {
                ...
                "desc": "释放设备锁",
                "body": None,
                "response": {"status": "bool", "serial": "str", "status": "ONLINE"},
                "errors": [],
    ...
    # ── case-manager (8 endpoints) ──
    {
        ...
        "items": [
            ...
            },
            {
                ...
                "desc": "单个用例详情",
                "body": None,
                "response": {"status": "bool", "definition": "dict"},
        ...
        "items": [
            {
                ...
                "desc": "可下载的报告文件列表",
                "body": None,
                "response": {"status": "bool", "files": "list[{name,size,time,type}]"},
                "errors": [],
    ...
    # ── dashboard (4 endpoints) ──
    {
        ...
        "items": [
            ...
            },
            {
                ...
                "desc": "最近平台活动时间线",
                "body": None,
                "response": {"status": "bool", "data": "[{type,action,detail,time}]"},
                "errors": [],
    ...
    return JsonResponse(
        {
            ...
            "conventions": {
                ...
                "error_format": '{"status": false, "message": "描述"}',
            },
