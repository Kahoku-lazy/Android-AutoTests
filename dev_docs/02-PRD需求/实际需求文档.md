...
> 基于已实现代码，合并全局 PRD 与 7 个子 PRD 的最终版本
> 版本：v1.0 · 日期：2026-07-01 · 子 PRD：元素定位 / 设备 / 用例 / 执行 / 报告 / AI / 仪表盘
...
| PF-06 | 报错诊断 | 常见错误快速诊断手册（见 `05-开发与测试/平台级/报错诊断手册.md`） | P2 |
...
| 版本 | 日期 | 变更摘要 |
|------|------|----------|
| v1.0 | 2026-07-01 | 合并全局PRD + 子PRD + 架构方案，只保留已实现内容。新增 AI-03~AI-11（原始 PRD 仅 2 个用户故事）。按实际代码重写模块 M7（Dify → AgentScope） |
| v1.1 | 2026-07-10 | 对齐前端 7 模块：补齐仪表盘子 PRD（`子PRD-07-dashboard.md`）；PRD 目录收敛为 1 总 + 7 子 + README |
