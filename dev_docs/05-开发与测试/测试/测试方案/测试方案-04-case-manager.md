...
> 文档定义 120 条 · 脚本已实现 48 条 (40%) · ✅=已实现 ⚠️=部分覆盖 ❌=未实现

| 分组 | 文档 | 已实现 | 覆盖率 |
|------|:--:|:--:|:--:|
| 2. 目录管理 API (CM-DIR) | 9 | 3 | ⚠️ 33% |
| 2. 目录树前端 (CM-TREE) | 13 | 10 | ⚠️ 77% |
| 3. 用例 CRUD API (CM-API) | 14 | 10 | ⚠️ 71% |
| 3. CRUD 往返验证 (CM-RT) | 4 | 3 | ⚠️ 75% |
| 4. 步骤类型验证 (CM-ST) | 17 | 1 | ❌ 6% |
| 4. 步骤编辑器 (CM-SE) | 16 | 3 | ❌ 19% |
| 5. 用例编辑器 (CM-ED) | 21 | 10 | ⚠️ 48% |
| 6. 用例列表 (CM-LIST) | 6 | 5 | ⚠️ 83% |
| 6. 用例卡片 (CM-CARD) | 6 | 2 | ❌ 33% |
| 6. 用例详情 (CM-DETAIL) | 4 | 2 | ⚠️ 50% |
| 6. YAML 导出 (CM-YAML) | 5 | 0 | ❌ 0% |
| 7. 安全测试 (CM-SEC) | 5 | 4 | ⚠️ 80% |
| **合计** | **120** | **48** | **40%** |
...
| 分组 | 子项 | 文档 | 已实现 | 覆盖率 | 脚本编号 |
|------|------|:--:|:--:|:--:|------|
| 目录管理 API | CM-DIR-01 ~ 09 | 9 | 3 | 33% | CASE-API-01-U,02-U, DB-08 |
| 目录树前端 | CM-TREE-01 ~ 13 | 13 | 10 | 77% | CASE-FUNC-01~08,18,25,26,29,33 |
| 用例 CRUD API | CM-API-01 ~ 14 | 14 | 10 | 71% | CASE-API-03~10, DB-07 |
| CRUD 往返验证 | CM-RT-01 ~ 04 | 4 | 3 | 75% | CASE-API-03,04, DB-04 |
| 步骤类型验证 | CM-ST-01 ~ 17 | 17 | 1 | 6% | CASE-FUNC-19 |
| 步骤编辑器 | CM-SE-01 ~ 16 | 16 | 3 | 19% | CASE-FUNC-15,19, DB-04 |
| 用例编辑器 | CM-ED-01 ~ 21 | 21 | 10 | 48% | CASE-FUNC-09,10,20~24 |
| 用例列表 | CM-LIST-01 ~ 06 | 6 | 5 | 83% | CASE-FUNC-03~05 |
| 用例卡片 | CM-CARD-01 ~ 06 | 6 | 2 | 33% | CASE-DATA-01 |
| 用例详情 | CM-DETAIL-01 ~ 04 | 4 | 2 | 50% | CASE-FUNC-22 |
| YAML 导出 | CM-YAML-01 ~ 05 | 5 | 0 | 0% | — |
| 安全测试 | CM-SEC-01 ~ 05 | 5 | 4 | 80% | CASE-WHITE-01~04 |
| **总计** | | **120** | **48** | **40%** | |
