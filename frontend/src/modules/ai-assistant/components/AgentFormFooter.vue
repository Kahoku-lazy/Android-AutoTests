...
.nav-prev:hover { background: var(--ai-bg-subtle); transform: translateX(-2px); }
.nav-next { background: var(--ai-teal); color: #fff; border-color: var(--ai-teal); }
.nav-next:hover { background: var(--ai-teal-hover); transform: translateX(2px); }
