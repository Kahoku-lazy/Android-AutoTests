...
export function useDevicePrompts() {
  ...
  return {
    prompts, draft, loading, saving, editing,
    load, startEdit, cancelEdit, save, autoSaveIfDirty,
    archives, archivesLoading, historyVisible, preview,
    openHistory, loadArchives, previewArchive, restoreArchive, removePermanentArchive,
  }
}
