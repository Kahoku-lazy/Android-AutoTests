...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: "/ai-assistant/toolbox/tools/:toolName",
    name: "ai-tool-debug",
    component: () => import("@/modules/ai-assistant/ToolDebugPage.vue"),
    meta: { title: "工具调试" },
  },
  {
    path: "/ai-assistant/toolbox/models/:role",
    name: "ai-model-debug",
    component: () => import("@/modules/ai-assistant/ModelDebugPage.vue"),
    meta: { title: "模型调试" },
  },
  {
    path: "/ai-assistant/agent/:agentId",
    name: "ai-agent-detail",
    component: () => import("@/modules/ai-assistant/AgentDetail.vue"),
    meta: { title: "智能体详情" },
  },
  {
    path: "/ai-assistant/tasks/:taskId",
    name: "ai-task-detail",
