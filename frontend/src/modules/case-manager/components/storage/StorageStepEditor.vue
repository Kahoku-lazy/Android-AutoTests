...
.step-number { width: 24px; height: 24px; border-radius: 50%; background: var(--app-green, #89CFF0); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 12px; flex-shrink: 0; }
