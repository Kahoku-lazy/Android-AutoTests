...
import { listDevices, connectDebugDevice as apiConnectDebugDevice, disconnectDebugDevice as apiDisconnectDebugDevice } from "../api/uiAutomation.js";
...
export function useDebugDevice() {
  ...
  async function loadDevices() {
    try {
      ...
      if (data.ok) devices.value = data.devices || [];
    } catch { /* ignore */ }
  }
