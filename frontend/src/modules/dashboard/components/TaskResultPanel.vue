    ...
    <div v-if="tasks.length" class="task-result-panel__list">
      ...
      >
        <div
          ...
          :class="meta(task.status).cls"
          :title="meta(task.status).label"
        >
...
.task-row__status.is-failed {
  background: var(--app-status-danger-bg);
  color: var(--app-status-danger-text);
}
.task-row__status.is-partial {
...
.case-icon.is-partial {
  background: var(--app-status-warning-bg);
  color: var(--app-warning-text);
}
.case-icon.is-running {
  background: var(--app-status-purple-bg);
  color: var(--app-status-purple-text);
}
