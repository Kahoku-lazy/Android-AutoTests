...
const allChecked = computed(
  () =>
    pagedItems.value.length > 0 && pagedItems.value.every((e) => store.checkedIds.has(e._rowKey)),
)
  ...
  <div class="sap">
    ...
    <div class="sap-body">
      ...
      <section class="sap-table">
        <div class="sap-pager">
          <span class="sap-page-info"
            >第 {{ currentPage }} / {{ totalPages }} 页 · 共 {{ elements.length }} 条</span
          >
          ...
          >
            ...
            <template #cell-thumbnail="{ row }">
              ...
              >
                ...
                >
                  <img
                    v-if="!brokenThumbs.has(row._rowKey)"
            ...
            <template #cell-name="{ row }">
              ...
              <div
                v-else
                class="sap-name-cell"
                :class="{ 'sap-name-cell--readonly': !canRename }"
            ...
            <template #cell-xpath="{ row }">
              <div class="sap-xpath">
                ...
                <el-tag
                  v-if="row.primary && row.primary.stable === false"
                  size="small"
                  type="warning"
                  class="sap-tag"
                  >不稳定</el-tag
    ...
    >
      <div v-if="enlargeRow" class="sap-enlarge">
        <div
          v-if="enlargeBroken || brokenThumbs.has(enlargeRow._rowKey)"
          class="sap-enlarge-missing"
        >
          缩略图已失效
        </div>
        <img
          v-else
          :src="mediaUrl(enlargeRow.thumbnail_path)"
          class="sap-enlarge-img"
        ...
        <div class="sap-enlarge-detail">
          ...
          <div class="sap-enlarge-field">
            <span>Bounds</span>{{ enlargeRow.coords?.bounds || "—" }}
          </div>
