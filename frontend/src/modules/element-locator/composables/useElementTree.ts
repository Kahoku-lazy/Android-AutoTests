...
export function useElementTree() {
  ...
  async function doRename() {
    ...
    try {
      ...
      ElMessage.error(e?.response?.data?.message || '重命名失败，请检查网络连接')
    }
  }
  ...
  async function doCreatePage() {
    ...
    try {
      ...
      ElMessage.error(e?.response?.data?.message || '创建失败，请检查网络连接')
    }
  }
  ...
  async function deletePage(page) {
    ...
    try {
      ...
      ElMessage.error(e?.response?.data?.message || '删除失败，请检查网络连接')
    }
  }
  ...
  async function doClearPages() {
    ...
    try {
      ...
      ElMessage.error(e?.response?.data?.message || '清空失败，请检查网络连接')
    }
  }
  ...
  async function executeBatchMove(pageIds, parentId) {
    try {
      ...
      ElMessage.error(e?.response?.data?.message || '移动失败，请检查网络连接')
    }
  }
