...
.task-meta-bar{display:flex;flex-wrap:wrap;gap:10px;padding:12px 16px;background:var(--app-bg-card);border:2.5px solid var(--ink);border-radius:6px 10px 6px 10px;margin-bottom:4px;font-size:var(--app-size-xs)}.task-meta-item{display:flex;align-items:center;gap:6px}.meta-label{opacity:0.5;font-weight:600}.meta-value{font-weight:700}.full-width{width:100%}.conclusion-text{font-style:italic}
...
.table-toolbar{display:flex;align-items:center;gap:10px;flex-wrap:wrap;padding:8px 16px 0}.page-size-btns{display:flex;gap:4px}.toolbar-label{font-size:var(--app-size-xs);font-weight:700;color:var(--app-ink-muted)}.page-size-btn{padding:4px 10px;font-size:var(--app-size-xs);font-weight:700;color:var(--app-ink-muted);background:var(--app-bg-card);border:2px solid #e8ecf1;border-radius:4px 8px 4px 8px;cursor:pointer;font-family:inherit}.page-size-btn:hover{border-color:var(--ink);color:var(--ink)}.page-size-btn.active{background:var(--app-bg-subtle);border-color:var(--ink);color:var(--ink)}.page-info{font-size:var(--app-size-xs);color:var(--app-ink-muted);font-weight:600;white-space:nowrap;margin-left:auto}.page-nav{display:flex;gap:6px;margin-left:8px}.page-nav :deep(.el-button){padding:4px 10px;font-size:var(--app-size-xs);font-weight:700;border:2px solid var(--ink)!important;border-radius:4px 8px 4px 8px!important;background:var(--app-bg-card);color:var(--ink)}.page-nav :deep(.el-button:hover){background:var(--c-dashboard)}
...
.fail-detail-row{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:8px}.fd-label{font-size:var(--app-size-xs);font-weight:700;opacity:0.4;text-transform:uppercase}.fd-value{font-size:var(--app-size-xs);font-weight:600}.fd-error{color:#a03030}.fail-step-row__head{display:flex;align-items:center;gap:8px;margin-bottom:4px}.fail-step-row__meta{font-size:var(--app-size-xs);color:var(--app-ink-muted)}
.mini-table{width:100%;border-collapse:collapse;font-size:var(--app-size-xs);margin:8px 0}.mini-table th{background:var(--app-bg-subtle);font-weight:700;font-size:var(--app-size-xs);text-transform:uppercase;letter-spacing:0.04em;padding:6px 10px;text-align:left;border-bottom:2px solid var(--ink)}.mini-table td{padding:6px 10px;border-bottom:1px solid #e8e4d8}.row-fail td{color:#a03030}
