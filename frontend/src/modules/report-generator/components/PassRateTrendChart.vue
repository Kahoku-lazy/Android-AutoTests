...
function buildOption() {
  ...
  return {
    ...
    yAxis: {
      ...
      min: 0,
      max: 100,
      axisLabel: { fontSize: 10, color: CHART_COLORS.axis.labelText, formatter: "{value}%" },
...
const { container } = useECharts(buildOption, () => [props.labels, props.rate, props.visibleDays], {
  group: props.group,
})
</script>
