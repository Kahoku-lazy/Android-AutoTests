...
<style scoped>
.detail-page{display:flex;flex-direction:column;height:100%;overflow-y:auto}.doc-body{padding:16px 20px 32px;display:flex;flex-direction:column;gap:14px;max-width:1200px;margin:0 auto;width:100%}
...
.log-section{background:#1e1e24;border:2.5px solid var(--ink);border-radius:6px 10px 6px 10px;overflow:hidden}.log-title{font-weight:700;font-size:var(--app-size-xs);color:#e0e0e0}.log-sub{font-size:var(--app-size-xs)}.log-card-body{padding:10px 16px;max-height:300px;overflow-y:auto;font-family:var(--app-font-mono);font-size:var(--app-size-xs);color:#a0aec0;line-height:1.6}.log-line{display:flex;gap:8px;padding:1px 0}.log-time{color:#555;flex-shrink:0}.log-empty{padding:20px;text-align:center;color:#666;font-size:var(--app-size-xs)}
