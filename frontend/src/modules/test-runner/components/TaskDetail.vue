...
.info-progress :deep(.el-progress-bar__outer){border-radius:4px;border:1px solid var(--ink);background:var(--app-border-lighter)}.info-progress :deep(.el-progress-bar__inner){background:var(--c-device)!important}.info-progress :deep(.el-progress__text){font-family:'Patrick Hand',cursive;font-weight:700}
