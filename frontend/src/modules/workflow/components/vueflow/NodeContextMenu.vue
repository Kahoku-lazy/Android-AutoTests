...
.node-menu {
  ...
  border-radius: 16px;
  box-shadow: 0 12px 36px rgba(139, 115, 85, 0.18);
  padding: 8px;
...
.search:focus { border-color: var(--ac-teal, #19c8b9); }
.source-tag {
  font-size: 10px;
...
.page-item:hover { background: rgba(25, 200, 185, 0.1); }
.page-item.active { background: rgba(25, 200, 185, 0.16); }
.page-name {
  font-size: 13px;
  font-weight: 800;
  display: flex;
