...
<template>
  <svg :width="size" :height="size" viewBox="0 0 48 48" fill="none" class="animated-mascot">
    <!-- Antenna -->
    <line x1="24" y1="6" x2="24" y2="12" stroke="var(--mascot-stroke)" stroke-width="2" stroke-linecap="round" />
    <circle cx="24" cy="4" r="2" fill="var(--mascot-antenna-tip)" />

    <!-- Legs -->
    <path ref="leftLegRef" d="M20 34 L18 44" stroke="var(--mascot-stroke)" stroke-width="3" stroke-linecap="round" />
    <path ref="rightLegRef" d="M28 34 L30 44" stroke="var(--mascot-stroke)" stroke-width="3" stroke-linecap="round" />

    <!-- Arms -->
    <path ref="leftArmRef" d="M12 22 Q8 28 12 34" stroke="var(--mascot-stroke)" stroke-width="3" stroke-linecap="round" />
    <path ref="rightArmRef" d="M36 22 Q40 28 36 34" stroke="var(--mascot-stroke)" stroke-width="3" stroke-linecap="round" />
    ...
    <g ref="bodyRef">
      ...
      <!-- Mouth -->
      <path d="M21 25 Q24 27 27 25" stroke="var(--mascot-ink)" stroke-width="1.5" stroke-linecap="round" fill="none" />
    </g>
