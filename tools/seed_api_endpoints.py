...
create_endpoint(
    ...
    "GET",
    "用例目录列表",
    "/api/cases/directories/",
    "完整目录树（可按 case_type 筛选）",
)
...
create_endpoint(
    g_rpt, "GET", "单次运行报告", "/api/reports/run/{run_id}/", "单次运行的完整聚合报告"
)
create_endpoint(
...
create_endpoint(
    ...
    "POST",
    "更新题库",
    "/api/evaluator/banks/{bank_id}/update/",
    "更新题库（全量替换）",
)
create_endpoint(
