...
from apps.case_manager.models import CaseDirectory, ApiTestCase
...
test_cases = [
    # ═══ 平台概览统计 ═══
    {
        ...
        "method": "GET", "url": abs_url("/api/dashboard/stats/"), "expected_status": 200,
        "priority": "P0", "enabled": True,
        "headers": jwt_headers(),
        ...
        "rows": rows_json(input_row("token", "{{JWT}}"), validate_row("$.ok", "True"), validate_row("$.data.system_status", "normal")),
    },
    {
        "id": "API-DASH-002",
    ...
    },
    {
        ...
        "method": "GET", "url": abs_url("/api/dashboard/stats/"), "expected_status": 401,
        "priority": "P0", "enabled": True,
    ...
    },
    {
        ...
        "steps_json": steps_json(
            request_step("/api/dashboard/stats/", 401, {"Authorization": "Bearer invalid_token_12345"}),
    ...
    # ═══ 近期活动 ═══
    {
        ...
        "method": "GET", "url": abs_url("/api/dashboard/activities/"), "expected_status": 200,
        "priority": "P1", "enabled": True,
        "headers": jwt_headers(),
    ...
    },
    {
        ...
        "method": "GET", "url": abs_url("/api/dashboard/activities/"), "expected_status": 401,
        "priority": "P0", "enabled": True,
    ...
    # ═══ 设备统计 ═══
    {
        ...
        "method": "GET", "url": abs_url("/api/devices/stats/"), "expected_status": 200,
        "priority": "P1", "enabled": True,
        "headers": jwt_headers(),
    ...
    },
    {
        ...
        "method": "GET", "url": abs_url("/api/devices/stats/"), "expected_status": 401,
        "priority": "P0", "enabled": True,
        "description": "缺少 JWT → 401",
        "steps_json": steps_json(
    ...
    # ═══ 用例统计 ═══
    {
        "id": "API-DASH-012",
        "title": "[正常] 用例统计 — 跨类型总数",
        "method": "GET", "url": abs_url("/api/cases/stats/"), "expected_status": 200,
        "priority": "P1", "enabled": True,
        "headers": jwt_headers(),
    ...
    },
    {
        ...
        "method": "GET", "url": "/api/cases/stats/", "expected_status": 401,
        "priority": "P0", "enabled": True,
        "description": "缺少 JWT → 401",
        "steps_json": steps_json(
